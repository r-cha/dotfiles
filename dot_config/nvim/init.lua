...
-- Set tab title to the project name
local tabtitle
local arg_dir = vim.fn.argv(0)
if arg_dir and vim.fn.isdirectory(arg_dir) == 1 and arg_dir ~= "." then
	tabtitle = vim.fn.fnamemodify(arg_dir, ":t")
else
	tabtitle = vim.fn.fnamemodify((vim.uv or vim.loop).cwd(), ":t")
end
vim.o.title = true
vim.o.titlestring = tabtitle .. " [nvim]"
...
require("lazy").setup({
	...
	{ -- Fuzzy Finder (files, lsp, etc)
		...
		config = function()
			...
			-- Make sure we can open a filebrowser
	...
	},
	{
		...
		config = function()
			...
			require("mason-lspconfig").setup({
				ensure_installed = {}, -- Install LSPs manually via :Mason
	...
	{ -- Highlight, edit, and navigate code
		...
		opts = {
			...
			-- Install parsers manually via :TSInstall <language>
			auto_install = false,
			highlight = {
				enable = true,
